...
【这个文件做什么】
mini-sglang 支持一堆环境变量调优（如 DISABLE_OVERLAP_SCHEDULING、
SHELL_TEMPERATURE 等）。本文件提供 ENV 单例，把"读环境变量 + 解析 + 默认值"
集中起来，其他代码用 ENV.SOME_VAR.value 拿到值，类型安全且统一。
...
【典型环境变量】
- DISABLE_OVERLAP_SCHEDULING: 关掉重叠调度（调试用）
- SHELL_TEMPERATURE / SHELL_TOP_K / ...: shell 模式的采样参数
========================================================================
"""
