"""
========================================================================
文件名: models/qwen3_moe.py
所属模块: Models - Qwen3 MoE 模型实现
========================================================================

Qwen3-MoE 把 FFN 换成 MoELayer（混合专家），其它结构和 Qwen3 一样。
每层有 N 个专家（FFN），每个 token 由 router 选 top-k 个专家计算。
参数量大但激活量小——很适合在显存充足的 GPU 上发挥。
========================================================================
"""
