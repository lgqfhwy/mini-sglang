...
========================================================================
文件名: models/utils.py
所属模块: Models - 通用工具（构建 Transformer Block 的脚手架）
========================================================================

提供一些"建模型用的便利函数"——具体模型文件（llama.py / qwen2.py 等）
调用这里的工具拼出完整 Transformer 结构，避免重复代码。
比如统一的 attention block / FFN block 构造、QKV 投影的合并等。
========================================================================
"""
