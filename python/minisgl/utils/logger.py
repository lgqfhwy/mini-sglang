...
【这个文件做什么】
- 为每个模块提供 init_logger(name) 工厂创建带颜色的 logger
- 提供 .info_rank0 / .warning_rank0 / .debug_rank0 等"只有主 rank 才打"
  的便捷方法（多 TP 时避免每个 rank 都打一遍）

【为什么自定义】
- 默认 logging 太啰嗦（需要 handler/formatter 一堆设置）
- 多卡场景下需要按 rank 过滤
- 想要 ANSI 颜色让日志好读
========================================================================
"""
